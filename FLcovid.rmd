...
url2<-"https://www.cdc.gov/coronavirus/2019-ncov/covid-data/files/2020-06-22-model-data.csv"
...
```{r}
kable(ttt2[1:(nrow(ttt2)-1),],caption="CFR By Month Number",table.attr = "style='width:75%;'")
