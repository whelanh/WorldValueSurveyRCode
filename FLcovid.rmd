...
# REad in FL DOH data
# cdcForecast<-data.table(read_csv("C:\\Users/whelanh/Downloads/2020-06-22-model-data.csv"))
...
colnames(ansMM2)<-c("lag","V1","lag2","V1rel")
 ...
 lagz <- lagz + geom_line(aes(x=cDat+bestLagNew, y= d7CaseRel, colour = paste("7-Day Avg Cases Older Than",ageCutoff," Fwd ",bestLagNew)))
...
#   # adding the relative humidity data, transformed to match roughly the range of the temperature
  lagz <- lagz + geom_line(aes(x=cDat, y = d7Death*20, colour = "7 Day Avg. Daily Deaths"))
# 
...
## Florida Case Fatality Ratio By Month
...
```{r}
kable(ttt2[1:(nrow(ttt2)-1),],caption="CFR By Month Number")

kable(tttc,caption = "Total Deaths and Cases By Month (based on Event Date)")
```
